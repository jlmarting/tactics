...
var TestTile = new Tile(0,0,'img/token_winter.png',141,50);
...
window.onload = function(){
    ...
    for(var i=0;i<20;i++){
        for(var j=0;j<20;j++){
            var soil = new ImgToken('soil_'+i+'_'+j,-5000+418*(i-1),-5000+418*(j-1) ,0,'img/SoilCracked_418x418.jpg',418,418);
    ...
    theScene.arrTokens.push(TestTile);
