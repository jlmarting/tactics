...
class ViewPort extends Rectangle {
    /**
     *
     * @param t ImgToken sobre el que pndremos foco
     */
    attachTo(t) {
        const pos = t.getRelPos();
        this.placeAt(pos.x, pos.y);
    }
}
class WorldTokens extends Array {
    loadImg() {
...
export class Scene {
    ...
    /**
     * Posición con respecto al mapa       const loadImg = function () {
    ...
    constructor(canvasId) {
        ...
        CursorPoint.prototype.draw = function (ctx) {
            ...
            // vector.b = p1;
            // vector.draw(ctx);
            let vector = new Vector(this.id + '_vect', p0.x, p0.y, p1.x, p1.y);
    ...
    draw(obj) {
        switch (obj.constructor) {
            case Point:
                ...
                break;
            case ImgToken:
                this.drawImgToken(obj);
                break;
            case ColliderToken:
                this.drawColliderToken(obj);
                break;
            default: break;
        }
    }
