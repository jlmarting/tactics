...
const Tile = function(x,y,src,width, height){
    this.src = src;
...
const Projectile = function(x,y,rad,displ,effect){
    Point.call(this,x,y);    
    this.from = null;
    this.rad = rad;        
    this.displ = displ;
...
const BulletProjectile = function(id,x,y,rad,displ,effect){
    Projectile.call(this,x,y,rad,displ,effect);    
...
Shooter.prototype.shot = function(effect){    
    var shotLapse = 50;
    var shotDispl = 6;  
    ...
    var bullet = new BulletProjectile(this.id, (xy.x), (xy.y), this.rad, shotDispl, effect);    
