...
const ImgToken = function(id,x,y,rad,src,width,height){
        ...
        this.w = width;
        this.h = height;                                       
        this.config = {viewName:false, selectable:false};         
...
const Projectile = function(x,y,rad,displ,callback){
    Point.call(this,x,y);    
    this.from = null;
    this.rad = rad;        
    this.displ = displ;
    this.originalRange = 800;    
...
const BulletProjectile = function(id,x,y,rad,displ,callback){
...
BulletProjectile.prototype.shot = function(tokens){
    ...
    return promiseBullet.then(function(moveResult){
        if ((moveResult.canMove==false)||(this.range==0)){
            this.displ=0;            
            this.effect(moveResult.collisions,this);             
        }
...
Shooter.prototype.shot = function(callback, startTime){    
    var shotLapse = 50;
    var shotDispl = 6;  
