...
export class Collider extends Point implements IToken{
    ...
    constructor(id: string, x: number, y: number, r: number) {
        ...
        this.config = {
            enabled: true,
            visible: true,
            innerColor: "rgba(255, 255, 15, 0.60)",
            borderColor: "magenta",
            borderWidth: 5
        };
        this.back = [];
    ...
    isCollisioning(otherCollider: Collider) {
        var self = this;
    ...
    */
    move(cmd: string, displ: number, tokens?: any[], callback?: any) {
        ...
        return colPromise.then(function (collisions: any) {
