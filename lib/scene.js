const Scene = function(canvasId){    //Lo que veremos en el canvas   
    ...
    this.config = {viewGrid:true, scale:1, viewColliders: false, viewIds: true, autoFPS: true, viewPortWidth: 1920, viewPortHeight: 900};
    this.config.grid = {height: 0, width: 0, granularity: 25};
