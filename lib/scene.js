const Scene = function(canvasId){    //Lo que veremos en el canvas   
    ...
    this.config = {viewLines:false, scale:1.5, viewColliders: false, viewIds: true, autoFPS: false, viewPortWidth: 1400, viewPortHeight: 1200};
    ...
    Rectangle.prototype.draw = function(lColor,fColor){
        ...
        var rw = this.w/2;
        var rh = this.h/2;
        self.ctx.rect(this.x-rw, this.y-rh, this.w, this.h);                
        self.ctx.stroke();    
    }
    ...
    Tile.prototype.draw = function(){
        ...
        self.ctx.save();
        self.ctx.drawImage(img, this.x, this.y);       
        self.ctx.restore();
    }
