const Engine = function(scene){
        ...
        this.automat = function(){
            scene.arrTokens.forEach(function(t){  //Según el tipo de token realizaremos unas u otras opciones                                                                  
                ...
                if (t.delete) {
                    const tokenIndex = scene.arrTokens.findIndex(function(element){
                ...
                if((t instanceof WireToken)&&(t.id == scene.getSelectedToken().id)){
                    ...
                    for(let i = 0; i<scene.arrTokens.length;i++){
                        const element = scene.arrTokens[i];
