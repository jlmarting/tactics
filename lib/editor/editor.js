    ...
    initEvents() {
        document.addEventListener('keypress', (e) => {
            ...
            if (e.keyCode === 110) {
                ...
                const wt = new wire_1.WireToken('wiretoken' + this.scene.arrTokens.length, firstPoint);
            ...
            if (e.keyCode === 115) {
                const p0 = new point_1.Point(0, 0);
                const wt = new wire_1.WireToken("demo", p0);
                wt.load(new point_1.Point(-250, 0));
                wt.load(new point_1.Point(250, 0));
                this.scene.arrTokens.push(wt);
                this.scene.setToken(wt.id);
                this.points = [];
        ...
        if (canvasElem) {
            canvasElem.onclick = (e) => {
                ...
                const p = new point_1.Point(mapX, mapY);
