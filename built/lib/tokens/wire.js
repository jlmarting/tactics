...
var WireToken = (function (_super) {
    __extends(WireToken, _super);
    function WireToken(id, p) {
        var _this = this;
        if (p == null) {
            ...
            _this = _super.call(this, p.x, p.y, 0) || this;
            _this.x = p.x;
            _this.y = p.y;
        }
        _this.id = id;
        _this.config = { viewName: false, selectable: true, position: 'relative', color: 'white', radial: false, enabled: true, closed: true, mesage: "" };
        _this.points = [];
        _this.mod_points = [];
        _this.bkpx;
        _this.bkpy;
        _this.bkppoints = [];
        _this.lastRad = _this.rad;
        return _this;
    }
